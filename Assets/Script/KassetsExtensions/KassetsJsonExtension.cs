...
namespace Kadinche.Kassets
{
    public static class KassetsJsonExtension
    {
        ...
        public static void LoadFromJsonPath<T>(this VariableCore<T> data, string fullpath)
        {
        ...
        /// <typeparam name="T">Data type to load. Must be serializable.</typeparam>
        public static void LoadFromJson<T>(this VariableCore<T> data, string filename)
        {
            LoadFromJson(data, DefaultPath, filename);
        }
